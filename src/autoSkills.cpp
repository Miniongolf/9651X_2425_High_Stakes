...
void auton::skills() {
    ...
    chassis.moveToPoint(24, 45, 1250, {.minSpeed = 100, .earlyExitRange = 12}, false); // Ring 2
    ...
    pros::delay(750);
    intake.setMode(Intake::modes::INDEX);
    chassis.swingToHeading(-25, lemlib::DriveSide::LEFT, 1000, {.minSpeed = 127});
    ...
    chassis.safeMoveToPoint(0, 51, 1000);
    pros::delay(300);
